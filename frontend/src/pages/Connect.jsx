...
const Connect = () => {
  ...
  return (
    <div className="bg-[#F3EFE9] min-h-screen">
      ...
      <section
        id="enquiry-section"
        className="py-24 px-4 md:px-8 bg-[#F3EFE9] relative z-10 overflow-hidden"
      >
      ...
      <section
        id="referral-section"
        className="py-24 md:py-32 px-4 md:px-8 bg-[#F3EFE9] relative z-10"
      >
