...
const GuestStoriesManager = () => {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const gs = pageData?.guestStoriesSection || {};
        setFormData((prev) => ({
          ...prev,
          title: gs.title || "Stories from Our Guests",
          subtitle: gs.subtitle || "Hear from those who have journeyed with us and shared their experiences.",
        }));
        setCurrentImage(gs.image || "");
      } catch {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await api.updateGuestStoriesSection(form);
      const gs = res.page?.guestStoriesSection || {};
      setCurrentImage(gs.image || "");
      ...
      let msg = "Guest Stories section updated!";
  ...
  return (
    <div className="space-y-6 mb-12 pb-12 border-b border-gray-200">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-[#4A3B2A]">Guest Stories Section Settings</h3>
      </div>
          ...
          {currentImage && (
            <div className="mb-3">
              ...
              <img
                ...
                alt="Current Guest Stories Section"
...
export default GuestStoriesManager;
