      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col justify-between hidden md:flex">
        <div>
          ...
          <nav className="px-4 space-y-1 mt-2">
            ...
            {/* Visual placeholder for other menu items */}
            {/* <div className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-500 opacity-50 cursor-not-allowed">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
