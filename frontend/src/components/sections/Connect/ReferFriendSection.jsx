...
const ReferFriendSection = ({ data }) => {
  ...
  return (
    <section
      id="referral-section"
      className="py-12 md:py-24 px-4 md:px-8 bg-[#F3EFE9] relative z-10"
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          {/* Right Content Block */}
          <div className="pt-12 lg:pt-0 flex flex-col items-center lg:items-start text-center lg:text-left">
