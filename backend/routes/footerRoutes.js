...
// Resolve upload folder for footer logo
...
// Route: PUT /api/footer — admin only
router.put(
  "/",
  requireAdmin,
  handleUpload,
...
// Route: DELETE /api/footer/logo — admin only
router.delete("/logo", requireAdmin, footerController.deleteLogo);
